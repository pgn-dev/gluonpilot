...
${OBJECTDIR}/_ext/1843177418/getErrLoc.o: ../../lib/microcontroller/getErrLoc.s  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_AS_PRE)  ../../lib/microcontroller/getErrLoc.s  -o ${OBJECTDIR}/_ext/1843177418/getErrLoc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG   -omf=elf -I".." -Wa,-MD,"${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d",--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d"  $(SILENT)  -rsi ${MP_CC_DIR}../  
	
else
${OBJECTDIR}/_ext/1843177418/getErrLoc.o: ../../lib/microcontroller/getErrLoc.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1843177418 
	@${RM} ${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d 
	${MP_CC} $(MP_EXTRA_AS_PRE)  ../../lib/microcontroller/getErrLoc.s  -o ${OBJECTDIR}/_ext/1843177418/getErrLoc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -omf=elf -I".." -Wa,-MD,"${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d",--defsym=__MPLAB_BUILD=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d"  $(SILENT)  -rsi ${MP_CC_DIR}../  
