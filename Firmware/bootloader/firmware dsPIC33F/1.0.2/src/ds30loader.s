...
;------------------------------------------------------------------------------
		...
		.ifdef HAS_PPS
			...
			bset	RPOR9, #RP19R0			;xxx
			bset	RPOR9, #RP19R1			;xxx
			bclr	RPOR9, #RP19R2			;xxx
			bclr	RPOR9, #RP19R3			;xxx
			bclr	RPOR9, #RP19R4			;xxx		
		.endif	
...
;------------------------------------------------------------------------------
		...
		; *** START MODIFICATION FOR GLUONPILOT ***
		; Apply the PLL config to make sure it runs at 40MHz, just like our firmware
		...
		ior.w W0,W1,W0
		mov.w W0,0x0746
		; *** STOP MODIFICATION FOR GLUONPILOT ***
...
;------------------------------------------------------------------------------
		.ifdef HAS_PPS
			...
			mov		PPSTEMP2, RPOR9		;xxx  pps settings
		.endif
