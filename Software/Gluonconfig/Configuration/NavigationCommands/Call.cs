...
{
    public partial class Call : UserControl, INavigationCommandViewer
    {
        private NavigationInstruction ni;

        public Call(NavigationInstruction ni)
        {
            InitializeComponent();
        ...
        public NavigationInstruction GetNavigationInstruction()
        {
            ...
            ni.opcode = NavigationInstruction.navigation_command.CALL;
