...
namespace Configuration
{
    public class NumericTextBox : TextBox
    {
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            NumberFormatInfo numberFormatInfo = System.Globalization.CultureInfo.InvariantCulture.NumberFormat;
        ...
        public int IntValue
        {
            get
            {
                ...
                {
                    int x =(int)Double.Parse(this.Text, System.Globalization.CultureInfo.InvariantCulture.NumberFormat);
