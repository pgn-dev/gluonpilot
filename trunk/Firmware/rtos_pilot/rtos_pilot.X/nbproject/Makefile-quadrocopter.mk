...
${OBJECTDIR}/_ext/1843177418/getErrLoc.o: ../../lib/microcontroller/getErrLoc.s  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_AS_PRE)  ../../lib/microcontroller/getErrLoc.s  -o ${OBJECTDIR}/_ext/1843177418/getErrLoc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -I".." -Wa,-MD,"${OBJECTDIR}/_ext/1843177418/getErrLoc.o.d",--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,-g,--no-relax$(MP_EXTRA_AS_POST)
